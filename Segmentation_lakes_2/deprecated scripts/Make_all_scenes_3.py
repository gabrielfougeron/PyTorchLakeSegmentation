...
output_fused_poly_folder = './polygons/fused_polygons/'
...
# model = torch.load("./trainings/5/MyTraining_019.pt")
# model = torch.load("./trainings/5/MyTraining_028.pt")
# model = torch.load("./trainings/5/MyTraining_038.pt")
# model = torch.load("./trainings/5/MyTraining_047.pt")
# model = torch.load("./trainings/5/MyTraining_057.pt")
model = torch.load("./trainings/5/MyTraining_085.pt")
model.to(device)
...
for file_path in input_img_list:
    ...
    with rio.open(file_p) as img_open:
        ...
        # img_uint8 = ((img[0,:,:]*0.8)).astype(np.uint8)
        # img_uint8 = ((img[0,:,:])).astype(np.uint8)
        # img_uint8 = ((img[0,:,:]*1.5)).astype(np.uint8)
